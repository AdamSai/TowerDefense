...
public class Grid : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        if (NodeArray != null)//If the grid is not empty
        {
            ...
            {
                if (n.IsTower)//If the current node is a wall node
                {
                ...
                Gizmos.DrawCube(n.Position, Vector3.one * (fNodeDiameter - fDistanceBetweenNodes));//Draw the node at the position of the node.
            }
        }
    }
}
